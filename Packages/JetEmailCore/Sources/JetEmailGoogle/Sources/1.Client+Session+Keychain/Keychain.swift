...
actor Keychain {
    ...
    func insertItem(gtmSession: GTMSession) throws -> GoogleSession.Item {
    ...
    func deleteItem(_ item: GoogleSession.Item) throws -> GoogleSession.Item {
        //SessionKeychain.assertIsolated()
        let query = [
    ...
    func item(id: GoogleAccountID) throws -> GoogleSession.Item? {
        //SessionKeychain.assertIsolated()
    ...
    var items: [GoogleSession.Item] { get throws {
        //SessionKeychain.assertIsolated()
        ...
        case errSecSuccess:
            ...
            let items: [GoogleSession.Item] = try attriutesList.map { attributes in
    ...
    func updateItem(_ item: GoogleSession.Item) throws -> GoogleSession.Item {
        checkBackgroundThread()
        let query = [
            kSecValuePersistentRef: item.keychainItem
        ] as [String : Any]
